...
encountertext = "Welcome to Create Your Kris (1.2?)!\rFeel free to [die]!" -- Modify as necessary. It will only be read out in the action select screen.
...
enemies = { "PoseurChap2", "PoseurChap2", "PoseurChap2" }
